...
const projects = [
  {
    ...
    moreDetails: {
      functionality:
        "Comprehensive industrial management solution that streamlines operations through automated tracking and analytics. The app enables real-time monitoring of inventory levels, employee productivity, and production metrics. Features automated report generation and data visualization for informed decision-making.",
      features: [
        "Real-time inventory tracking with low-stock alerts",
        "Employee attendance and performance monitoring",
        "Production line analytics and efficiency metrics",
  ...
  },
  {
    ...
    moreDetails: {
      functionality:
        "Social networking platform that connects people through shared interests and local events. Users can discover nearby events, join communities, and interact through real-time messaging. The app uses location-based services to suggest relevant events and matches users with similar interests.",
      features: [
        "Browse and filter events by category and location",
        "Real-time group and private messaging",
        "GPS-based event recommendations",
        "Interest-based user matching algorithm",
        "Personalized social feed with event updates",
      ],
    },
    image:
  ...
  },
  {
    ...
    moreDetails: {
      functionality:
        "Intelligent travel companion that provides real-time traffic information and optimal route suggestions. Integrates weather data to help users plan trips effectively. Offers personalized travel recommendations based on user preferences and historical data.",
      features: [
        "Live traffic monitoring with alternative routes",
        "AI-powered route optimization",
        "7-day weather forecast integration",
        "Personalized travel time suggestions",
  ...
  },
  {
    ...
    moreDetails: {
      functionality:
        "Movie discovery platform powered by AI that learns user preferences to provide personalized film recommendations. Users can create custom watchlists, read and write reviews, and share their favorite movies with friends. Includes trailer previews and detailed movie information.",
      features: [
        "Machine learning-based movie recommendations",
        "Create and organize multiple watchlists",
        "Share movies and reviews on social media",
        "Community-driven movie ratings and reviews",
        "Integrated movie trailers and cast information",
      ],
    },
    image:
  ...
  },
  {
    ...
    moreDetails: {
      functionality:
        "Feature-rich note-taking application with seamless cloud synchronization across all devices. Supports collaborative editing where multiple users can work on notes simultaneously. Advanced organization through tags, folders, and search functionality.",
      features: [
        "Automatic cloud sync across all devices",
        "Tag-based organization and smart folders",
  ...
  },
  {
    ...
    moreDetails: {
      functionality:
        "Complete dental clinic management system for handling patient records, appointments, and billing. Automates appointment reminders to reduce no-shows. Maintains comprehensive treatment history for each patient with digital records and billing integration.",
      features: [
  ...
  },
  {
    ...
    moreDetails: {
      functionality:
        "Advanced CRM system for managing sales pipelines and tracking performance metrics. Provides data-driven insights through interactive charts and analytics. Features predictive forecasting to help businesses plan and optimize their sales strategies.",
      features: [
  ...
  },
  {
    ...
    moreDetails: {
      functionality:
        "Complete restaurant management solution for table reservations, online ordering, and customer engagement. Restaurant owners can manage menus, track orders in real-time, and collect customer feedback. Customers can book tables, place orders, and track their delivery status.",
      features: [
        "Real-time table availability and booking",
        "Online food ordering with payment integration",
        "Dynamic menu management for restaurants",
        "Live order tracking from kitchen to delivery",
